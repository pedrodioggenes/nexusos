// ─── NexusOS UI — barrel exports ─────────────────────────────────────────────
// Import from "@/components/ui" to get any component without deep paths.

// Alert / Feedback
export { AlertService, type AlertOptions } from "./AlertService";
export { default as AlertServiceDefault } from "./AlertService";
...
// Tooltip — primitives + SimpleTooltip convenience wrapper
export {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
