...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-sm px-2.5 py-1 text-xs font-medium ring-offset-background",
      // Smooth transitions — position, color, opacity, shadow
      ...
      "relative after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:h-[2px] after:rounded-full after:bg-primary",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      // Fade-in when tab becomes active
